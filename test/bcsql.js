...
contract('bcSQL', function(accounts) {
    ...
    it("Create DB", function () {
        return bcSQL.deployed().then(function (instance) {
            console.log('Contract at ' + instance.address);
            bcsql = instance;
            return bcsql.createDb('db1', {from: accounts[0]});
            ...
            return bcsql.getDbsCount.call();
        }).then(function (result) {
            assert.equal(result.toNumber(), 1, '1 Db was created');
            return bcsql.getDbNameByIndex.call(0);
        }).then(function (result) {
    ...
    it("Create other DB", function () {
        return bcSQL.deployed().then(function () {
            return bcsql.createDb('db2', {from: accounts[1]});
        }).then(function (result) {
            assert.equal(result.logs[0].event, 'DbCreated');
            ...
            return bcsql.getDbData.call('db2');
        }).then(function (result) {
    ...
    it("Init table", function() {
        return bcSQL.deployed().then(function () {
            return bcsql.initTable('db1', 'table1', {from: accounts[0]});
        }).then(function (result) {
    ...
    it("Init other table", function() {
        return bcSQL.deployed().then(function () {
            return bcsql.initTable('db1', 'table2', {from: accounts[0]});
        }).then(function (result) {
            assert.equal(result.logs[0].event, 'TableInited');
    ...
    it("Init 3rd table", function() {
        return bcSQL.deployed().then(function () {
            return bcsql.initTable('db2', 'table1', {from: accounts[0]});
        }).then(function(result) {
            assert.equal(result.logs[0].event, 'TableInited');
            ...
            assert.equal(result.logs[0].args.name, 'table1');
            assert.equal(result.logs[0].args.owner, accounts[0]);
            return bcsql.getDbData.call('db1');
        }).then(function (result) {
    ...
    it("Get table id", function() {
        return bcSQL.deployed().then(function () {
            return bcsql.getTableId.call('db1', 'table1');
        }).then(function (result) {
    ...
    it("Get tables count", function() {
        return bcSQL.deployed().then(function () {
            return bcsql.getTablesCount.call();
        }).then(function (result) {
    ...
    it("Get table data", function() {
        return bcSQL.deployed().then(function () {
            return bcsql.getTableData.call(0);
        }).then(function (result) {
    ...
    it("Add columns to table", function() {
        return bcSQL.deployed().then(function () {
            return bcsql.addColumn(0, 'id', 'int', false, true, true);
        }).then(function (result) {
            return bcsql.getTableData.call(0);
        }).then(function (result) {
            assert.equal(result[5].toNumber(), 1, 'Table must has 1 column');
            return bcsql.addColumn(0, 'payload', 'string', true, false, false);
        }).then(function (result) {
            return bcsql.getTableData.call(0);
        }).then(function (result) {
    ...
    it("Get columns data", function() {
        return bcSQL.deployed().then(function () {
            return bcsql.getColumnData.call(0, 0);
        }).then(function (result) {
            ...
            return bcsql.getColumnData.call(0, 1);
        }).then(function (result) {
    ...
    it("Insert", function() {
        ...
        return bcSQL.deployed().then(function () {
            return bcsql.insert(0, infohash);
        }).then(function (result) {
